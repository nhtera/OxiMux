...
/**
 * The one empty-state layout: an optional muted icon, a title, and an optional
 * explanatory line — centred. Replaces the per-screen ad-hoc muted text so
 * every "nothing here" reads the same.
 */
